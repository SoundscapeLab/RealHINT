function [snr50_Cafe1_1] = RealHINT_EHF2251F_Cafe1_1(start, sentences, subject_num)
%%%%%%%%%%%%%%%%%%%%%%%%%
%
%%%%%%%%%%%%%%%%%%%%%%%%%
...
% calculate SNR50
snr50_Cafe1_1 = mean(RealHINTCafe1_SNRs(4:20));

% save data
nameSave = sprintf('Subject_%3d_RealHINT_EHF2251F_Cafe1_1', subject_num);
% Generate text file
...
% display SNR
message = sprintf('The SNR50 is %.2f dB', snr50_Cafe1_1);
