function [snr50_LivingRoom_1] = RealHINT_EHF2251F_LivingRoom_1(start, sentences, subject_num)
%%%%%%%%%%%%%%%%%%%%%%%%%
%
%%%%%%%%%%%%%%%%%%%%%%%%%
...
% calculate SNR50
snr50_LivingRoom_1 = mean(RealHINTLivingRoom_SNRs(4:20));

% save data
nameSave = sprintf('Subject_%3d_RealHINT_EHF2251F_LivingRoom_1', subject_num);
% Generate text file
fid = fopen([nameSave '_info.txt'],'w');
fprintf(fid,'%s %s\r\n','File generated on: ', datetime("now"));
fprintf(fid,'%s %.2f\r\n','Environment Check Lnoise ', Lnoise);
fprintf(fid,'%s %d\r\n','Subject ', subject_num);
fprintf(fid,'%s %.2f\r\n','SNR50 = ',snr50_LivingRoom_1);
...
% display SNR
message = sprintf('The SNR50 is %.2f dB', snr50_LivingRoom_1);
