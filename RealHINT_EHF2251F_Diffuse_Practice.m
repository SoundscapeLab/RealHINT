function [] = RealHINT_EHF2251F_Diffuse_Practice(start, sentences)
%%%%%%%%%%%%%%%%%%%%%%%%%
%
%%%%%%%%%%%%%%%%%%%%%%%%%
...
uiwait(msgbox('PRACTICE - DIFFUSE'));
...
% calculate SNR50
%snr50_Diffuse_Practice = mean(RealHINTDiffuse_SNRs(4:20));

% save data
%nameSave = sprintf('Subject_%3d_RealHINT_EHF2251F_Diffuse_Practice', subject_num);
% Generate text file
%fid = fopen([nameSave '_info.txt'],'w');
%fprintf(fid,'%s %s\r\n','File generated on: ', datetime("now"));
%fprintf(fid,'%s %.2f\r\n','Environment Check Lnoise ', Lnoise);
%printf(fid,'%s %d\r\n','Subject ', subject_num);
%fprintf(fid,'%s %.2f\r\n','SNR50 = ',snr50_Diffuse_Practice);
